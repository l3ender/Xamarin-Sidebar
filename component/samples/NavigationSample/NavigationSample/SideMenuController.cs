...
namespace NavigationSample
{
	public partial class SideMenuController : BaseController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			var title = new UILabel (new CGRect (0, 50, 230, 20));
			title.Font = UIFont.SystemFontOfSize (24.0f);
			title.TextAlignment = UITextAlignment.Center;
			title.TextColor = UIColor.Blue;
			title.Text = "Menu";

			var body = new UILabel (new CGRect (30, 70, 170, 100));
			...
			introButton.Frame = new CGRect (0, 180, 230, 20);
			...
			contentButton.Frame = new CGRect (0, 220, 230, 20);
